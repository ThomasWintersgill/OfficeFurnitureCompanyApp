...
public class Main extends javax.swing.JFrame {
    ...
    //Stores the objects after they are created to be displayed in the basket Jlist on the basket panel.
    ...
    private void initComponents() {
        ...
        deskPicPanel.setBackground(new java.awt.Color(255, 255, 255));
        deskPicPanel.setPreferredSize(new java.awt.Dimension(329, 280));

        deskPicLabel.setBackground(new java.awt.Color(255, 255, 255));
        deskPicLabel.setIcon(new javax.swing.ImageIcon("desk.jpg"));
        ...
        deskPicPanelLayout.setHorizontalGroup(
            ...
            .addGroup(deskPicPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(deskPicLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 301, Short.MAX_VALUE)
                .addGap(22, 22, 22))
        );
        deskPicPanelLayout.setVerticalGroup(
            ...
            .addGroup(deskPicPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(deskPicLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(deskFormPanelLayout.createSequentialGroup()
                .addGroup(deskFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(deskFormPanelLayout.createSequentialGroup()
                        ...
                        .addGap(346, 366, Short.MAX_VALUE))
                    .addGroup(deskFormPanelLayout.createSequentialGroup()
                        .addGap(67, 67, 67)
                        .addGroup(deskFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(deskFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(deskFormPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(deskFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(drawersField, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        tablePicPanel.setBackground(new java.awt.Color(255, 255, 255));
        tablePicPanel.setPreferredSize(new java.awt.Dimension(329, 280));

        jLabel16.setBackground(new java.awt.Color(255, 255, 255));
        jLabel16.setIcon(new javax.swing.ImageIcon("table.jpg"));
        jLabel16.setBackground(new java.awt.Color(255, 255, 255));
        ...
        tablePicPanelLayout.setVerticalGroup(
            tablePicPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(tablePicPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel16, javax.swing.GroupLayout.DEFAULT_SIZE, 268, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon("chair.jpg"));
        ...
        chairPicPanelLayout.setHorizontalGroup(
            ...
            .addGroup(chairPicPanelLayout.createSequentialGroup()
                ...
                .addGroup(chairFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(chairFormPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(chairFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(chairPicPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(chairFormPanelLayout.createSequentialGroup()
    ...
    private void showSummaryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showSummaryButtonActionPerformed
        /*Pop up informs user that summary has been output,
        felt this was neccessary as the output is in the console
        ...
        if (!basket.isFull()) {
            if (!chairIdField.getText().isBlank()) {
                if (idNumbers.contains(chairIdField.getText())) {
                    ...
                    //Every new ID number must be added to idNumbers as they can be used only once.
                    idNumbers.add(chairIdField.getText());

                    //Following 4 lines collate details from the chair form.
                    ...
                    //Total price label is always updated after an item is added.
        ...
        if (!basket.isFull()) {
            if (!tableIdField.getText().isBlank()) {
                if (idNumbers.contains(tableIdField.getText())) {
                    ...
                    //The following 5 lines collate all the data from the table form.
        ...
        if (!basket.isFull()) {
            if (!deskIdField.getText().isBlank()) {
                if (idNumbers.contains(deskIdField.getText())) {
                    ...
                    //The following 6 lines collate the data from the desk form.
    ...
    private void loadBasketBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadBasketBtnActionPerformed
        ...
        //Sets the directory to the current project.
        ...
        if (a == JFileChooser.APPROVE_OPTION) {
            ...
            /*Create a temporary basket, in the event of the wrong file type being chosen
            the original basket can still be accessed.
             */
            Basket tempBasket = new Basket();
            tempBasket = tempBasket.loadBasket(file);

            /*Check that the new basket has atleast one furniture object,
            the current basket can then be overwritten. 
             */
            if (!tempBasket.isEmpty()) {
                basket = tempBasket;

                //clear dm of the old furniture objects.
                dm.clear();

                //add the new furniture objects into the dm list model so they can be rendered
    ...
    private void clearBasketBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearBasketBtnActionPerformed
        ...
        if (!basket.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Basket is already empty");
        }
